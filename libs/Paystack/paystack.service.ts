...
export class PaystackService {
  ...
  createCustomer(customer: CreateCustomerData) {
    return this.consumer.sendRequest<CreateCustomerResponse>(
      'POST',
      '/customer',
      customer,
    );
  ...
  validateCustomer(customerCode: CodeOrId, body: ValidateCustomerData) {
    return this.consumer.sendRequest<PaystackResponse>(
      'POST',
  ...
  createDVA(body: CreateDedicatedVirtualAccountData) {
    return this.consumer.sendRequest<CreateDedicatedVirtualAccountResponse>(
      'POST',
      '/dedicated_account',
      body,
    );
  ...
  deactivateDVA(dedicatedAccountId: number) {
    return this.consumer.sendRequest<DeactivateDedicatedVirtualAccountResponse>(
      'DELETE',
  ...
  createRecipient(body: CreateRecipientData) {
    return this.consumer.sendRequest<CreateRecipientResponse>(
      'POST',
      '/transferrecipient',
      body,
    );
  ...
  initiateTransfer(body: InitiateTransferData) {
    return this.consumer.sendRequest<TransferResponse>(
      'POST',
      '/transfer',
      body,
    );
  ...
  verifyTransfer(reference: string) {
    return this.consumer.sendRequest<TransferEventData>(
      'GET',
  ...
  verifyTransaction(reference: string) {
    return this.consumer.sendRequest<VerifyTransaction>(
      'GET',
