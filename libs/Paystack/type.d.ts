...
type ChargeSuccessWebhookEvent = 'charge.success';
type TransferWebhookStatus = 'success' | 'failed' | 'reversed';
type TransferWebhookEvent =
  | 'transfer.success'
  | 'transfer.failed'
  | 'transfer.reversed';
type CustomerIdentificationEvent =
...
interface CreateDedicatedVirtualAccountResponse
  extends PaystackResponse<DedicatedVirtualAccountResponseData> {}

interface DeactivateDedicatedVirtualAccountResponse
  extends PaystackResponse<DedicatedVirtualAccountResponseData> {}
...
interface CreateRecipientResponse
  extends PaystackResponse<CreateRecipientResponseData> {}
...
interface TransferResponse
  extends PaystackResponse<InitiateTransferDataResponse> {}
...
interface ChargeSuccessEvent {
  event: ChargeSuccessWebhookEvent;
  data: ChargeSuccessEventData;
}
